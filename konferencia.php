...
<main class="container">
    <img src="fsharp-logo.png" alt="logo" class="center2">
        ...
        <div class="panel" style="text-align: center;">
            ...
            <?php
            if ($userdata){
                echo '<a href="dolgozat.php" style="text-decoration: none;">';
        echo    '<button class="butt" style="display: block; margin: 0 auto; margin-top: 60px; margin-bottom: 100px;">Jelentkezz itt!</button>';
        echo '</a>';
            }
            else{
        echo '<a href="jelentkezes.php" style="text-decoration: none;">';
        echo    '<button class="butt" style="display: block; margin: 0 auto; margin-top: 60px; margin-bottom: 100px;">Jelentkezz itt!</button>';
        echo '</a>';}
        ?>
        <!-- <div class="panel" > -->
