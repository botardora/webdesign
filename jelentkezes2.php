...
<body>
  ...
  <form action="jelentkezes2.php" method="post">
    <label for="tipus">Válasszon:</label><br>
    <select id="tipus" name="tipus" required>
        <option value="eloado">Előadó fiók</option>
        <option value="nezo">Néző fiók</option>
      </select><br><br>
      <br><input class="button" type="submit" value="Bejelentkezés" name="submit">
